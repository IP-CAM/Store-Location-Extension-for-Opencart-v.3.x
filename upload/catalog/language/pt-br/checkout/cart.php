...
$_['text_success']             = '<div class="info"><h1>Você adicionou <a href="%s">%s</a> ao seu <a href="%s">carrinho de compras</a></1>! <h2 class="pt-3">O que deseja fazer?</h2><br/></div><div class="modal-buttons">
<a href="#" class="btn btn-secondary" data-dismiss="modal">Continuar Comprando</a> ou <a href="/carrinho" class="btn btn-success">Abrir carrinho de compras</a>
</div>';
