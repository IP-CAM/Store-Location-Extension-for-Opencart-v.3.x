...
//$_['text_instock']             = '<span style="display:inline-block;border-radius:50%;width:8px;height:8px;margin-right:3px;background-color: green "></span><span style="font-weight:bold; green" class="text-success"> Em estoque</span>';
