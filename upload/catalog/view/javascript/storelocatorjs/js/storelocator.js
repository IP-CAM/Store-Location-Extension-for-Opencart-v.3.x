        ...
        "./src/storelocator/js/default-options.js": function (t, e, o) {
            ...
            e.default = {
                ...
                map: {
                    ...
                    options: { center: [46.227638, 2.213749], disableDefaultUI: !1, fullscreenControl: !0, mapTypeControl: !1, mapTypeId: "roadmap", scaleControl: !1, scrollwheel: !0, streetViewControl: !1, styles: [], zoom: 6 },
                },
            ...
            e.default = class {
                ...
                addEvents() {
                    this.sidebarResults.addEventListener("click", this.onClickSidebarResultItem.bind(this)),
                        [...this.nav.querySelectorAll("[data-switch-view]")].forEach((t) => {
            ...
            Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.default = function ({ store: t, origin: e }) {
                    return `\n\t\t<div class="storelocator-infoWindow">\n\t\t\t${
                        ...
                        t.lng
                    }" title="Abrir no Google Maps" target="_blank" class="storelocator-detailStoreDistance">\n\t\t\t\t\t<span></span>\n\t\t\t\t\t${r.default}\n\t\t\t\t\t</a>\n\t\t\t\t${
                        ...
                        t.phone ? `<span class="storelocator-detailStorePhone"><i class="fas fa-phone"></i><a href="tel:${t.phone}" title="Ligar">${t.phone}</a></span>` : ""
                    }\n\t\t\t\t${t.email ? `<span class="storelocator-detailStoreEmail"><i class="fas fa-at"></i><a href="mailto:${t.email}" title="">${t.email}</a></span>` : ""}\n\t\t\t\t
                    ${t.link ? `<span class="storelocator-detailStoreSite"><i class="fa fa-link"></i> <a href="${t.link}" title="website" target="_blank" class="storelocator-detailStoreUrl">${t.link}</a></span>` : ""
                    }\n\t\t\t</div>\n\t\t</div>`;
                });
            var s,
        ...
        "./src/storelocator/js/templates/sidebar-item-result.js": function (t, e, o) {
            ...
            Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.default = function ({ store: t, origin: e }) {
                    ...
                    }\n\t\t\t\t<a href="http://www.google.fr/maps/dir/${e}/${t.lat},${t.lng}" title="Abrir no Google Maps" target="_blank" class="storelocator-detailStoreDistance">\n\t\t\t\t\t<span></span>\n\t\t\t\t\t${
                        r.default
                    }\n\t\t\t\t</a>\n\t\t\t\t${t.address ? `<span class="storelocator-detailStoreAddress">${t.address}</span>` : ""}\n\t\t\t\t${
                        t.zipcode ? `<span class="storelocator-detailStoreZipcode">${t.zipcode}</span>` : ""
                    }\n\t\t\t\t${t.city ? `<span class="storelocator-detailStoreCity">${t.city}</span>` : ""}\n\t\t\t\t${
