                ...
                if (!empty($category['products'])) {
                    ...
                    foreach ($category['products'] as $key2 => $product) {
                        ...
                        if ($this->config->get('module_pdf_catalog_display_manufacturer_name') == 1 && isset($product['manufacturer_name']) ) {
                          ...
                          if ($this->config->get('module_pdf_catalog_display_manufacturer_name') != 1 || $this->config->get('pdf_catalog_display_manufacturer_logo') != 1 || empty($product['manufacturer_name']) || empty($product['manufacturer_logo_url'])){
