...
class ControllerExtensionModuleLiveSearch extends Controller {
	...
	public function injectLiveSearch(&$route, &$data, &$output) {
		if($this->config->get('module_live_search_status')){
            ...
            $liveSearchJS = '<link href="catalog/view/javascript/live_search/live_search.css?ver=1.0.1" rel="stylesheet" type="text/css">'."\n";
            $liveSearchJS .= '<script src="catalog/view/javascript/live_search/live_search.js?ver=1.0.1"></script>'."\n";
