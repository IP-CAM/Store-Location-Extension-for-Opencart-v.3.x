...
class ControllerExtensionModulePriceSlider extends Controller {
    ...
    public function index() {
        ...
        $this->document->addScript('catalog/view/javascript/bootstrap/js/bootstrap-slider.js');
        $this->document->addStyle('catalog/view/javascript/bootstrap/css//bootstrap-slider.css');
        ...
        if($this->config->get('module_price_slider_category')){
        $data['module_show_category'] = $this->config->get('module_price_slider_category');
        /* show categories */
        ...
        foreach ($results as $result) {
            ...
            $data['categories'][] = array(
                ...
                'href' => $this->url->link('product/category', 'language=' . $this->config->get('config_language') . '&path=' . $this->request->get['path'] . '_' . $result['category_id'])
            );
        }
        /* and categories */
        }
