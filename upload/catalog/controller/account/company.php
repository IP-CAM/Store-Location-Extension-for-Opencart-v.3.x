...
class ControllerAccountCompany extends Controller {
    ...
    public function delete() {
        ...
        if (isset($this->request->get['company_id']) && $this->validateDelete()) {
            $this->model_account_address->deleteAddress($this->request->get['company_id']);

            // Default Shipping Address
            if (isset($this->session->data['shipping_address']['company_id']) && ($this->request->get['company_id'] == $this->session->data['shipping_address']['address_id'])) {
            ...
            // Default Payment Address
            if (isset($this->session->data['payment_address']['address_id']) && ($this->request->get['company_id'] == $this->session->data['payment_address']['company_id'])) {
    ...
    protected function getList() {
        ...
        $data['default_company'] = $this->customer->getCompanyId();
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['default'])) {
            ...
            $data['default'] = $this->customer->getCompanyId() == $this->request->get['company_id'];
        } else {
            $data['default'] = false;
        }
    ...
    protected function validateDelete() {
        if ($this->model_account_company->getTotalCompany() == 1) {
            $this->error['warning'] = $this->language->get('error_delete');
        }

        if ($this->customer->getCompanyId() == $this->request->get['company_id']) {
