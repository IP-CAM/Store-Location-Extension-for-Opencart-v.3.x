...
class ControllerCommonCookie extends Controller {
    ...
    public function index() {
        if ($this->config->get('config_cookie_id') && !isset($this->request->cookie['policy'])) {
            ...
            if ($information_info) {
                ...
                $data['text_cookie'] = sprintf($this->language->get('text_cookie'), $this->url->link('information/information', 'language=' . $this->config->get('config_language') . '&information_id=' . $information_info['information_id']));
    ...
    public function confirm() {
        ...
        if ($this->config->get('config_cookie_id') && !isset($this->request->cookie['policy'])) {
            ...
            oc_setcookie('cookie-read-FeassoBrasil', $agree, $option);
