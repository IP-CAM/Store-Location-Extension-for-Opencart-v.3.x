	...
	oc_drawing = {
		...
		deleteSelectedShape: function() {
			...
			if (this.selectedShape) {
				...
				for(var k in this.shapes) {
					...
					if(shape._id_ == oc_drawing.selectedShape._id_) {
		...
		create_rectangle: function(_data,_map) {
	        ...
	        return  new google.maps.Rectangle({
				...
				strokeWeight : 1,
				type:'rectangle',
				editable:(oc_drawing.allow_edit)?oc_drawing.allow_edit:false,
				map: _map,
		...
		create_polygon: function(_points,_map,_shape) {
	        ...
	        return new google.maps.Polygon({
			    ...
			    strokeWeight : 1,
			    editable: (oc_drawing.allow_edit)?true:false, // Editable geometry off by default
			    type:'polygon',
			    map:_map
			});
